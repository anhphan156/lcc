...
#include "defs.h"
#include "token.h"
enum AST_NODE_TYPE { AST_STMTS_BLOCK, AST_STMT, AST_DECL, AST_FUNC, AST_FUNC_CALL, AST_LVALUE, AST_BIN_OP, AST_UN_OP, AST_LITERAL_NUMBER, AST_DOUBLE, AST_GROUPING, AST_IDENTIFIER, AST_DEREF, AST_ADDR };
